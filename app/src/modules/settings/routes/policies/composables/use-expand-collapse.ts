...
export function useExpandCollapse() {
	const collapsedIds = useLocalStorage<string[]>('collapsed-policy-ids', []);

	const hasExpandablePolicies = computed(() => true);

	return { collapsedIds, hasExpandablePolicies, expandAll, collapseAll, toggleCollapse };
